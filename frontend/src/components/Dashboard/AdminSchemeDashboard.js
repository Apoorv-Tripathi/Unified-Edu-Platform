...
import { Award, TrendingUp, Users, DollarSign, FileText, CheckCircle, XCircle, Clock, Plus, Filter, Download } from 'lucide-react';
        ...
        <div className="col-md-3">
          <div className="card border-0 shadow-sm stat-card" style={{ background: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)' }}>
            <div className="card-body p-4 text-white">
              <div className="d-flex justify-content-between">
                <div>
                  <p className="mb-2 opacity-90">Budget Utilized</p>
                  <h2 className="fw-bold mb-2">₹{(analytics?.totalUtilized / 10000000 || 0).toFixed(1)}Cr</h2>
                  <small className="opacity-90">{analytics?.utilizationRate}% of allocated</small>
                </div>
                <div className="icon-wrapper">
                  <DollarSign size={28} />
                </div>
                  ...
                  <div className="card-body p-3">
                    ...
                    <div className="d-flex justify-content-between text-sm">
                      <div>
                        ...
                        <div className="fw-semibold">₹{(scheme.benefits?.amount || 0).toLocaleString()}</div>
                      </div>
                      <div className="text-end">
                        <div className="text-muted small">Applications</div>
                        <div className="fw-semibold">{scheme.statistics?.totalApplications || 0}</div>
                      </div>
                    </div>
                  </div>
                </div>
