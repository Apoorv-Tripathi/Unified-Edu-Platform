...
import { Award, Users, DollarSign, TrendingUp, CheckCircle, Clock, XCircle, FileText, Search } from 'lucide-react';
              ...
              <tbody>
                {stats?.recentApplications?.map((app, i) => (
                  <tr key={i}>
                    ...
                    <td>
                      <span className={`badge bg-${app.status === 'Approved' ? 'success' :
              ...
              <div key={scheme._id} className="col-md-4">
                <div className="card border application-card">
                  <div className="card-body p-3">
                    ...
                    <p className="small text-muted mb-2">{scheme.shortName}</p>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      <div>
                        ...
                        <div className="fw-bold">₹{(scheme.amount?.max || scheme.amount?.min || 0).toLocaleString()}</div>
                      </div>
